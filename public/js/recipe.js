...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Components_Recipe_RecipeHome__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__RecipeListItem__ = __webpack_require__(108);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var RecipeHome = function (_Component) {
    _inherits(RecipeHome, _Component);

    function RecipeHome(props) {
        _classCallCheck(this, RecipeHome);

        var _this = _possibleConstructorReturn(this, (RecipeHome.__proto__ || Object.getPrototypeOf(RecipeHome)).call(this, props));
    ...
    _createClass(RecipeHome, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('http://localhost:8000/api/v1/get-recipes', {
                'headers': {
                    'Authorization': 'Bearer 0mXTxjf6BkzZ5FIj7qbvW9SOBIeJY1tr1WZyBttEoKuzmTlRvA6jiXWERT4Z'
                }
            }).then(function (response) {
                return _this2.setState({ recipes: response.data });
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                recipes.map(function (recipe) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__RecipeListItem__["a" /* default */], { key: recipe.id, recipe: recipe });
                })
            );
        }
    }]);
...
/* harmony default export */ __webpack_exports__["a"] = (RecipeHome);
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "card" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { className: "card-img-top text-center", src: '/storage/food_image/' + props.recipe.image, alt: "Card image cap", style: { width: '130px' } }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "card-body" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
